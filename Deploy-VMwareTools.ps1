<#
.SYNOPSIS
    This script performs the installation or uninstallation of VMware Tools.
    # LICENSE #
...
.EXAMPLE
    PowerShell.exe .\Deploy-VMwareTools.ps1 -DeploymentType "Install" -DeployMode "NonInteractive"
.EXAMPLE
    PowerShell.exe .\Deploy-VMwareTools.ps1 -DeploymentType "Install" -DeployMode "Silent"
.EXAMPLE
    PowerShell.exe .\Deploy-VMwareTools.ps1 -DeploymentType "Install" -DeployMode "Interactive"
.EXAMPLE
    PowerShell.exe .\Deploy-VMwareTools.ps1 -DeploymentType "Uninstall" -DeployMode "NonInteractive"
.EXAMPLE
    PowerShell.exe .\Deploy-VMwareTools.ps1 -DeploymentType "Uninstall" -DeployMode "Silent"
.EXAMPLE
    PowerShell.exe .\Deploy-VMwareTools.ps1 -DeploymentType "Uninstall" -DeployMode "Interactive"
.NOTES
